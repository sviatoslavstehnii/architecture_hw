...
Also there is retry functionality, if we do not turn on logging_service, facade_service will try a couple of times to get response from it.
Code for retry:

![Screenshot from 2025-02-11 16-56-02](https://github.com/user-attachments/assets/6cd2df73-d577-4118-a261-ce5f26a1ef92)



Output from facade_service:


![Screenshot from 2025-02-11 16-55-43](https://github.com/user-attachments/assets/e51e534c-cb04-419f-9fba-8cc944d76913)
